-- Phase: Products CRUD enablement, storage bucket and policies, validation trigger (retry without IF NOT EXISTS)
...
CREATE POLICY "Suppliers can view their product images"
ON storage.objects
