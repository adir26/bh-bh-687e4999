-- Create leads table for contact supplier submissions
CREATE TABLE public.leads (
  ...
  CONSTRAINT leads_status_check CHECK (status IN ('new', 'responded', 'archived'))
);
...
CREATE POLICY "Suppliers can update leads sent to them"
ON public.leads
FOR UPDATE
