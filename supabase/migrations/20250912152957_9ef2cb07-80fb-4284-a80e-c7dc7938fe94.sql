-- Corrected Unified Favorites System and Meeting Booking Migration
...
EXCEPTION
  WHEN undefined_table THEN
    NULL; -- Ignore if favorites table doesn't exist
END $$;
...
-- RLS policies for availability (only create if they don't exist)
DO $$
BEGIN
...
-- RLS policies for bookings (only create if they don't exist)
DO $$
BEGIN
