-- Update create_order_bundle RPC to handle ghost clients and customer details
...
BEGIN
  ...
  IF (payload->'project'->>'mode') = 'create' THEN
    ...
    VALUES (
      v_client_id, 
      v_supplier,
      COALESCE(payload->'project'->'new'->>'title', 'פרויקט חדש'),
  ...
  -- Get calculated total from triggers
