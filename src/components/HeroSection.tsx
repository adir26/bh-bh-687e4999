...
export const HeroSection: React.FC<HeroSectionProps> = ({ href = '/welcome', onCTAClick, showCTA = true }) => {
  ...
  return (
    <div className="relative h-48 xs:h-56 sm:h-64 mx-3 xs:mx-4 mb-4 xs:mb-6 rounded-2xl overflow-hidden">
      <SafeImage 
        src={heroImage}
      ...
      {/* Content overlay */}
      <div className="absolute inset-0 flex flex-col justify-end p-4 xs:p-5 sm:p-6 text-white">
        <div className="space-y-2 xs:space-y-3">
          <h2 className="text-lg xs:text-xl font-bold leading-tight">
            בנו את הבית החלומות שלכם
          </h2>
          <p className="text-xs xs:text-sm text-white/90 leading-relaxed">
