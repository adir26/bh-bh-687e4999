...
export const Header: React.FC<HeaderProps> = ({
  ...
  return <header className="md:hidden flex justify-between items-center self-stretch bg-neutral-50 pt-[max(env(safe-area-inset-top),12px)] pb-2 px-3 xs:pb-2 xs:px-4 sm:px-5 sticky top-0 z-50">
      ...
      <div className="flex w-10 h-10 xs:w-12 xs:h-12 justify-end items-center gap-2">
        {user && <>
            <button className="flex h-10 w-10 xs:h-12 xs:w-12 justify-center items-center rounded-xl hover:bg-gray-100 active:scale-95 transition-all focus-ring" aria-label="Notifications" onClick={handleNotificationsClick}>
