...
export const Header: React.FC<HeaderProps> = ({
  ...
  return <header className="md:hidden flex justify-between items-center self-stretch bg-neutral-50 pt-safe-header pb-2 px-3 pl-safe pr-safe xs:pb-2 xs:px-4 sm:px-5 sticky top-0 z-50">
