    ...
    <div className="min-h-screen bg-background flex flex-col" dir="rtl">
      ...
      <div className="relative h-64 mx-6 mb-6 rounded-2xl overflow-hidden">
        ...
        <div className="absolute bottom-6 right-6 text-white">
          ...
          <p className="text-white/90">נמשיך לבנות יחד</p>
        </div>
      </div>

      {/* Content */}
      <div className="flex-1 px-6 pb-nav-safe">
        <div className="max-w-md mx-auto">
          {/* Title */}
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-2">התחברות</h2>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input 
                        ...
                        className="rounded-xl h-12 bg-muted/50 border-muted" 
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
